...
int main()
{
    ...
    printf("Servidor TFTP esperando paquetes...\n");
    ...
    while (1)
    {
        ...
        { // RRQ
            ...
            {
                perror("No se pudo abrir recibido.txt");
                 // Enviar paquete vacío o de error al cliente
                unsigned char error_pkt[4] = {0x00, 0x00, 0x00, 0x00};
                sendto(sockfd, error_pkt, 4, 0, (struct sockaddr *)&cliaddr, len);
